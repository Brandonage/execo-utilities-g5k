...
if __name__ == '__main__':
    ...
    vagrantdcos_deployment.install_cassandra(ncassandra="6",nseeds="2")
    ...
    workloads = ["workloada"]
    vagrantdcos_deployment.ycsb_run(iterations=5,res_dir = "no_fmone",workloads=workloads, recordcount="8000",threadcount="3", fieldlength="1000", target="100")
